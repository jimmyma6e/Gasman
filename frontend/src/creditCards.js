...
export const CREDIT_CARDS = [
  ...
  },
  {
    ...
    type: "combo",
    discount_cpl: 3,
    partner_brands: ["Shell"],
    cashback_pct: 2,
    color: "#ec1c24",
    note: "3¢/L instant at Shell (link Scene+ to Shell Go+, up to 7¢/L w/ points) + 2% cash back anywhere",
  },
  {
  ...
  },
  {
    ...
    cashback_pct: 1,
    color: "#ec1c24",
    note: "3¢/L instant at Shell (link Scene+ to Shell Go+, up to 6¢/L w/ points) + 1% cash back anywhere",
  },
];
